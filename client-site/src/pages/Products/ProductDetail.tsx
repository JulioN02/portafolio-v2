...
export function ProductDetailPage() {
  ...
  const technicalImages = product.technicalImages ?? [];
      ...
      <div className={styles.container}>
        ...
        {product.fullDescription && (
          <div className={styles.fullDescription}>
            ...
            <div dangerouslySetInnerHTML={{ __html: renderSimulatorEmbeds(product.fullDescription) }} />
          </div>
        )}

        {/* Technical explanation (rich, sanitized, embeds preserved) */}
        {product.technicalExplanation && (
          <section className={styles.technicalSection}>
            <h2 className={styles.sectionTitle}>{t('productDetail.technicalExplanation')}</h2>
            <div
              className={styles.fullDescription}
              dangerouslySetInnerHTML={{ __html: renderSimulatorEmbeds(product.technicalExplanation) }}
            />
          </section>
        )}
        ...
        {technicalImages.length > 0 && (
          <section className={styles.technicalSection}>
            <h2 className={styles.sectionTitle}>{t('productDetail.technicalImages')}</h2>
