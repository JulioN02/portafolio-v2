...
import { loginHandler, meHandler, updateProfileHandler, sendVerificationCodeHandler, changePasswordHandler, } from '../controllers/auth.controller.js';
const router = Router();
// POST /api/auth/login - Login (public)
router.post('/login', loginHandler);
// POST /api/auth/logout (protected - could be used to invalidate token server-side if needed)
router.post('/logout', authMiddleware, requireAdmin, (_req, res) => {
